...
{
	profile->qvals = NULL;
	sxs_myfree(profile->in);
	sxs_myfree(profile->err);

	sxs_myfree(profile->VV);
	sxs_myfree(profile->VD);
	sxs_myfree(profile->VW);
	sxs_myfree(profile->DD);
	sxs_myfree(profile->DW);
	sxs_myfree(profile->WW);
}
